...
<%--                    <span><a class="modifyDish" href="javascript:;" dishid=${dish.dishId} dish=${dish.dishName}><img src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改" title="修改"/></a></span> 删除和修改都不是用户能干的事情--%>
